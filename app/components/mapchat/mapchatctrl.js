...
gcontroller.controller('MapChatCtrl',function($scope,$http, $rootScope, geolocation, gservice, MapChatService) {
    ...
    var broadcastLocation = function(data){
        ...
        MapChatService.emit("greetings", user);
    };
